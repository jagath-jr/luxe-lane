...
export default function KidsPage() {
  ...
  // Updated dummy product data for the Kids' page
  const products = Array(8).fill({
    title: "KIDS PLAYFUL PRINT T-SHIRT",
    price: "₹1200",
    originalPrice: "₹1500",
    image: "https://images.unsplash.com/photo-1519241047957-be31d7379a5d?q=80&w=600&auto=format&fit=crop"
  });
    ...
    <div ref={pageRef} className="w-full min-h-screen bg-white pb-24 pt-4 md:pt-8 text-black">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <section className="relative w-full h-[40vw] md:h-[65vh] md:min-h-[450px] lg:h-[500px] bg-[#f3f5f6] overflow-hidden rounded-[2rem] md:rounded-[3rem]">
          {/* Note: Update this src to your actual kids' hero banner image */}
          <img 
            src="/kids-hero.png" 
          ...
          <div>
            ...
            <div className="mb-6 border-b border-gray-200 pb-6">
             ...
             <div className="mb-6 border-b border-gray-200 pb-6">
              ...
              <ul className="flex flex-col gap-3 text-[13px]">
                {['2-3Y', '4-5Y', '6-7Y', '8-9Y', '10-12Y'].map((item) => (
             ...
             <div className="mb-8">
              ...
              <div className="relative w-full h-1 bg-gray-300 rounded-full mb-3 mt-2">
                ...
                <div className="absolute left-[20%] top-1/2 -translate-y-1/2 w-3 h-3 bg-white border border-gray-400 rounded-full shadow-sm cursor-pointer hover:scale-110 transition-transform"></div>
                <div className="absolute right-[40%] top-1/2 -translate-y-1/2 w-3 h-3 bg-white border border-gray-400 rounded-full shadow-sm cursor-pointer hover:scale-110 transition-transform"></div>
              </div>
              <p className="text-[11px] text-gray-500">From ₹500-₹3000</p>
            </div>
            {/* Action Buttons */}
          ...
          <div className="relative bg-white w-[85%] max-w-sm h-full overflow-y-auto p-6 flex flex-col gap-8 transition-transform transform duration-300 ml-auto shadow-2xl">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="mb-4">
                ...
                <p className="text-xs text-gray-500">From ₹500-₹3000</p>
              </div>
            </div>
